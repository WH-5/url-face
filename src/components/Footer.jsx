  ...
  return (
    <footer className="footer">
      <div className="container">
        <a href="https://github.com/WH-5/url-face" target="_blank" rel="noopener noreferrer" className="github-link">
        ...
        <p className="copyright">© wanghui.</p>
        <p className="record-number">备案号</p>
      </div>
    </footer>
  );
};
